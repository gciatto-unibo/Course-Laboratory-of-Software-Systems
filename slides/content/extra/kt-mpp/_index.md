...
> Nowadays, by "platforms" we mean not only OS but __runtimes__ too ⇒ __multi-platform__ applications must support several runtimes and OS
...
8. If properly configured, Kotlin lets developers follow this approach
